...
function generateSlug(sourceKey) {
  return function(ctx, next) {
    ...
    if (typeof data.slug.linked !== "undefined" && !data.slug.linked) {
      return next();
    }
      ...
      if (typeof slugConfig === "object" && (typeof slugConfig.type === "undefined" ||  slugConfig.type === "object")) {
        console.log("slug is object");
          ...
          if (typeof data.slug !== "object") {
             ...
             console.log("data.slug created obj", data.slug);
          } else {
            data.slug.url = newSlug;
          }
      } else {
          console.log("slug is string:", newSlug);
        data.slug = newSlug;
      }
    }
