            ...
            function createChild(relationInstance, relationModel) {
                return function (childData, childCb) {
                    ...
                    for (var childRelationName in relationModelRelations) {
						...
						console.log('childRelationObj:', childRelationObj);
					...
					console.log('child data and options:', childData, childOptions);
					console.log('creating child', relationModel.definition.name);
