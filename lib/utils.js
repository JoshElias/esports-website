...
function validateYoutubeId(ctx, finalCallback) {
    ...
    var youtubeId = getEventualValue(ctx, "youtubeId");
...
function validateYoutubePlaylistId(ctx, finalCallback) {
    var youtubeVars = getEventualValue(ctx, "youtubeVars");
    if(_.isEmpty(youtubeVars) || _.isEmpty(youtubeVars.list)) {
        return finalCallback();
    }
...
=======
          ...
          console.log('roleNames:', roleNames);
            var filter = filter.filter
>>>>>>> 94740c4c63b62ee3fd2d696513d82a3ed77ba192
