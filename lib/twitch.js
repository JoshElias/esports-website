...
function twitchFeedHandler( req, res ) {
	console.log("Calling twitch feed handler");
	...
	async.waterfall([
		...
		function(seriesCallback) {
			console.log("Getting tempo active feed");
		...
		function(tempostormFeed, userHandles, seriesCallback) {
			console.log("Cleaning active feed");
		...
		function(feeds, seriesCallback) {
			console.log("Filtering active feed");
	...
	function(err, streamFeed) {
		console.log("Finished generating feed");
		console.log(err);
